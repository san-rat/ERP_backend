...
namespace ApiGateway.Controllers
{
    ...
    public class GatewayController : ControllerBase
    {
        ...
        private static object[] GetDefaultRoutes() => new object[]
        {
            ...
            new { upstream = "/api/ml/forecast/*", downstream = "ForecastService:5005/api/forecasting/*", auth = true },
            new { upstream = "/api/ml/churn/*", downstream = "PredictionService:5006", auth = true },
            new { upstream = "/api/ml/model-management/*", downstream = "PredictionService:5006/api/ml/*", auth = true },
            new { upstream = "/api/ml/segmentation/*", downstream = "PredictionService:5006", auth = true },
            new { upstream = "/api/ml/*", downstream = "PredictionService:5006/api/ml/*", auth = true },
            ...
            new { upstream = "/product/swagger/*", downstream = "ProductService:5004/swagger/*", auth = false },
            new { upstream = "/admin/health", downstream = "AdminService:5011", auth = false },
            new { upstream = "/admin/swagger/*", downstream = "AdminService:5011/swagger/*", auth = false },
            new { upstream = "/forecast/health", downstream = "ForecastService:5005", auth = false },
            new { upstream = "/forecast/swagger/*", downstream = "ForecastService:5005/swagger/*", auth = false },
            new { upstream = "/prediction/health", downstream = "PredictionService:5006", auth = false },
            new { upstream = "/prediction/db-check", downstream = "PredictionService:5006", auth = false },
            new { upstream = "/prediction/swagger/*", downstream = "PredictionService:5006/swagger/*", auth = false },
            new { upstream = "/analytics/health", downstream = "AnalyticsService:5007", auth = false },
            new { upstream = "/analytics/swagger/*", downstream = "AnalyticsService:5007/swagger/*", auth = false },
        ...
        private static object[] GetDockerRoutes() => new object[]
        {
            ...
            new { upstream = "/api/ml/forecast/*", downstream = "forecastservice:8080/api/forecasting/*", auth = true },
            ...
            new { upstream = "/api/ml/churn/*", downstream = "predictionservice:8080/api/ml/churn/*", auth = true },
            new { upstream = "/api/ml/model-management/*", downstream = "predictionservice:8080/api/ml/*", auth = true },
            new { upstream = "/api/ml/segmentation/*", downstream = "predictionservice:8080/api/ml/segmentation/*", auth = true },
            new { upstream = "/api/ml/*", downstream = "predictionservice:8080/api/ml/*", auth = true },
            new { upstream = "/prediction/health", downstream = "predictionservice:8080/health", auth = false },
            new { upstream = "/prediction/db-check", downstream = "predictionservice:8080/db-check", auth = false },
            ...
            new { upstream = "/api/dashboard/*", downstream = "analyticsservice:8080/api/dashboard/*", auth = true },
