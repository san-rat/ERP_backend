...
namespace ApiGateway.Controllers
{
    ...
    public class GatewayController : ControllerBase
    {
        ...
        private static object[] GetDockerRoutes() => new object[]
        {
            ...
            new { upstream = "/auth/swagger", downstream = "authservice:8080/swagger/index.html", auth = false },
            ...
            new { upstream = "/customer/swagger", downstream = "customerservice:8080/swagger/index.html", auth = false },
            ...
            new { upstream = "/order/health", downstream = "orderservice:8080/api/health", auth = false },
            new { upstream = "/order/swagger", downstream = "orderservice:8080/swagger/index.html", auth = false },
            ...
            new { upstream = "/product/swagger", downstream = "productservice:8080/swagger/index.html", auth = false },
            ...
            new { upstream = "/forecast/swagger", downstream = "forecastservice:8080/", auth = false },
            new { upstream = "/forecast/swagger/*", downstream = "forecastservice:8080/*", auth = false },
            ...
            new { upstream = "/prediction/swagger", downstream = "predictionservice:8080/swagger/index.html", auth = false },
            ...
            new { upstream = "/analytics/swagger", downstream = "analyticsservice:8080/swagger/index.html", auth = false },
            ...
            new { upstream = "/admin/swagger", downstream = "adminservice:8080/swagger/index.html", auth = false },
